...
#
# ADMIN_CONTACT_EMAIL = 'jason@aiera.com'
# Contact email for users to use if the software encounters errors
ADMIN_CONTACT_EMAIL = environ.get("ADMIN_EMAIL", "jason@aiera.com")
ADMIN_USER = environ.get("ADMIN_USER", "admin")
ADMIN_PASSWORD = environ.get("ADMIN_PASSWORD", "12345")
...
# AIERA SPECIFIC
AIERA_API_KEY = environ.get("AIERA_API_KEY")
AIERA_RESOLVE_API = environ.get("AIERA_RESOLVE_API")
